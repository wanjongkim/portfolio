...
const Works = () => {
    return (
        <div className="flex flex-col mt-16 px-6 pb-10">
            <div className="mb-5">
            ...
            <div className="flex flex-col bg-white rounded-2xl px-5 pt-5 pb-10 shadow-md">
            ...
            <div className="flex flex-col bg-white rounded-2xl px-5 pt-5 pb-10 shadow-md mt-12">
                <img className="rounded-2xl shadow-md" src="https://img4.cityrealty.com/neo/i/p/mig/airbnb_guide.jpg" />
                <div className="flex flex-col text-center">
